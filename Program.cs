...
namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //this code block execute if inputNumber is NOT divisible by 2
                Console.WriteLine("\tinputNumber is odd");
            ...
            {
                //this code block executes if the above conditon is true
                //the rest of the conditions will no longer execute
            ...
            int randomNumber = new Random().Next(10); //generate a random number 10 or below
